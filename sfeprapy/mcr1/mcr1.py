...
from sfeprapy.mcr1.mc_simulation_func import calc_time_equivalence_worker, calc_time_equivalence
from sfeprapy.mcr1.mc_inputs_generator import mc_inputs_generator
...
def run():
    ...
    # ==================================================================================================================
    # Plot all figures if no simulations to main
    # ==================================================================================================================
    ...
    for i, list_dict_mc_params in enumerate(list_list_dict_mc_params):
        ...
        print(sum(df_output['fire_type'].values==1))
