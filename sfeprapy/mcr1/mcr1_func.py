...
def calc_time_equivalence(
    ...
    # TODO: UPDATED FOR RESEARCH
    # fire_spread_speed = (fire_alpha * fire_t_alpha) / (fire_hrr_density * room_breadth)
    # fire_t_alpha = fire_spread_speed * room_breadth * (fire_hrr_density*1000) / fire_alpha
    # fire_t_alpha = 1050 / ((fire_hrr_density*1000) * room_breadth * fire_spread_speed)
    # alpha = np.pi * fire_spread_speed ** 2 * fire_hrr_density
    fire_t_alpha = (1050 / (np.pi * fire_spread_speed ** 2 * (fire_hrr_density * 1e3))) ** 0.5
    ...
    if fire_mode == 0:  # enforced to ec parametric fire
        ...
        # print(fire_spread_entire_room_time < burn_out_time, 0.125 <= (window_area / room_floor_area) <= 0.5)
    ...
    solver_steel_temperature_fixed_thickness_solved = 0
    if protection_thickness > 0:
        solver_steel_temperature_fixed_thickness_solved = _steel_temperature_max(
            time=fire_time,
            temperature_ambient=fire_temp,
            rho_steel=beam_rho,
            area_steel_section=beam_cross_section_area,
        ...
        )  # NOTE! variable out function scope
    ...
    solver_steel_temperature_fixed_thickness_solved_trav = np.nan
    solver_steel_temperature_fixed_thickness_solved_parm = np.nan
    if fire_type == 1:
        solver_steel_temperature_fixed_thickness_solved_trav = solver_steel_temperature_fixed_thickness_solved
    elif fire_type == 2:
        solver_steel_temperature_fixed_thickness_solved_parm = solver_steel_temperature_fixed_thickness_solved
    ...
    results = {
        ...
        'solver_steel_temperature_fixed_thickness_solved': solver_steel_temperature_fixed_thickness_solved,
        'fire_t_alpha': fire_t_alpha,
        'room_wall_thermal_inertia': room_wall_thermal_inertia,
        'room_height': room_height,
        'window_area':window_area,
        'window_open_fraction':window_open_fraction,
        'solver_steel_temperature_fixed_thickness_solved_trav': solver_steel_temperature_fixed_thickness_solved_trav,
        'solver_steel_temperature_fixed_thickness_solved_parm': solver_steel_temperature_fixed_thickness_solved_parm
    }
