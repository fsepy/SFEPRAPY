...
- `sfeprapy.mcs0` currently does capture column element.
- (WIP) `sfeprapy.mcs2`, similar to `sfeprapy.mcs0` but does not solve structural protection thickness for a predefined failure temperature, i.e. structural protection thickness is predefined.
